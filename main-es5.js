  ...
  function srcAppResumeResumeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ResumeComponent = /*#__PURE__*/function () {
      ...
      _createClass(ResumeComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var hostname = window.location.hostname; // Pega os parâmetro da URL

          var resumeId = this.route.snapshot.queryParams.resumeId || this.resumeService.getResumeId(hostname);
          this.styleName = this.route.snapshot.queryParams.style || this.resumeService.getStyleName(hostname); // Carrega os dados do currículo

          this.resume = this.resumeService.getResume(resumeId); // Altera o title do navegador
    ...
    ResumeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [["class", "style", 3, "ngClass", 4, "ngIf"], [1, "style", 3, "ngClass"], [1, "header"], [1, "box-resume"], [1, "sidebar"], ["class", "perfil-img", 4, "ngIf"], ["title", "Contato", 3, "dataLines", 4, "ngIf"], ["title", "Endere\xE7o", 3, "dataLines", 4, "ngIf"], ["title", "Data de nascimento", 3, "data", 4, "ngIf"], ["class", "box-skills", 4, "ngIf"], [1, "main-content"], ["class", "row", 4, "ngIf"], [1, "row-flex"], [1, "col"], ["class", "sub-title", 4, "ngIf"], [3, "title", "data", 4, "ngFor", "ngForOf"], ["class", "col", 4, "ngIf"], [1, "row"], [3, "dateFrom", "dateTo", "title", "subTitle", "dataLines", "hide", 4, "ngFor", "ngForOf"], [1, "perfil-img"], [3, "src"], ["title", "Contato", 3, "dataLines"], ["title", "Endere\xE7o", 3, "dataLines"], ["title", "Data de nascimento", 3, "data"], [1, "box-skills"], [3, "title", "dataWords", 4, "ngFor", "ngForOf"], [3, "title", "dataWords"], [1, "sub-title"], [3, "title", "data"], [3, "dateFrom", "dateTo", "title", "subTitle", "dataLines", "hide"]],
      ...
      _createClass(LoginComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.loginService.listenState().subscribe(function (state) {
            return _this8.showWindow = state;
          });
          this.initForm();
        }
      }, {
        ...
        value: function btLogin() {
          ...
          if (this.formLogin.valid) {
            ...
            this.authService.login(email, password).subscribe(function (response) {
              _this9.showWindow = false;

              _this9.route.navigateByUrl('/panel');
            }, function (error) {
              if (error.status === 401) return _this9.alertService.msgError('Usuário ou senha inválidos!');

              _this9.alertService.msgError('Ocorreu um erro, tente novamente!');
            });
          } else {
            this.alertService.msgError('Verifique se todos os campos foram preenchidos corretamente!');
          }
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.registerService.listenState().subscribe(function (state) {
            return _this10.showWindow = state;
          });
          this.initForm();
        }
      }, {
        ...
        value: function btRegister() {
          ...
          if (this.formRegister.valid) {
            ...
            this.usersService.create(fullName, email, password).subscribe(function (response) {
              if (response.status === 'success') {
                _this11.alertService.msgSuccess('Cadastro efetuado com sucesso!');

                _this11.showWindow = false;
              }
            }, function (error) {
              if (error.status === 400) {
                var errorMessage = Object.values(error.error.message[0].constraints)[0];

                _this11.alertService.msgError(errorMessage);
              } else if (error.status === 403) {
                _this11.alertService.msgError(error.error.message);
              } else {
                _this11.alertService.msgError('Ocorreu um erro, tente novamente!');
              }
            });
          } else {
            this.alertService.msgError('Verifique se todos os campos foram preenchidos corretamente!');
      ...
      _createClass(ResumesService, [{
        ...
        value: function getAll() {
          ...
          return this.http.get(this.resourceUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            ...
            if (error.status === 401) _this12.authService.logout();
