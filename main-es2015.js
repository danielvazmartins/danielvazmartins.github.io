...
function CourseGroupComponent_ng_container_0_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "label");
...
CourseGroupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CourseGroupComponent, selectors: [["app-course-group"]], inputs: { title: "title", data: "data", show: "show" }, decls: 1, vars: 1, consts: [[4, "ngIf"]], template: function CourseGroupComponent_Template(rf, ctx) { if (rf & 1) {
...
ExperienceGroupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ExperienceGroupComponent, selectors: [["app-experience-group"]], inputs: { dateFrom: "dateFrom", dateTo: "dateTo", title: "title", subTitle: "subTitle", data: "data", dataLines: "dataLines", show: "show" }, decls: 1, vars: 1, consts: [["class", "row-flex", 4, "ngIf"], [1, "row-flex"], [1, "col", "left"], [4, "ngIf"], [1, "col", "right"], [1, "title"], [1, "sub-title"], [3, "innerHTML"], [3, "innerHTML", 4, "ngFor", "ngForOf"]], template: function ExperienceGroupComponent_Template(rf, ctx) { if (rf & 1) {
...
ResumeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ResumeComponent, selectors: [["app-resume"]], decls: 1, vars: 1, consts: [["class", "style", 3, "ngClass", 4, "ngIf"], [1, "style", 3, "ngClass"], [1, "header"], [1, "box-resume"], [1, "sidebar"], ["class", "perfil-img", 4, "ngIf"], ["title", "Contato", 3, "dataLines", 4, "ngIf"], ["title", "Endere\u00E7o", 3, "dataLines", 4, "ngIf"], ["title", "Data de nascimento", 3, "data", 4, "ngIf"], ["class", "box-skills", 4, "ngIf"], [1, "main-content"], ["class", "row", 4, "ngIf"], [1, "row-flex"], [1, "col"], ["class", "sub-title", 4, "ngIf"], [3, "title", "data", 4, "ngFor", "ngForOf"], [3, "title", "data", "show", 4, "ngFor", "ngForOf"], ["class", "col", 4, "ngIf"], [1, "row"], [3, "dateFrom", "dateTo", "title", "subTitle", "dataLines", "show", 4, "ngFor", "ngForOf"], [1, "perfil-img"], [3, "src"], ["title", "Contato", 3, "dataLines"], ["title", "Endere\u00E7o", 3, "dataLines"], ["title", "Data de nascimento", 3, "data"], [1, "box-skills"], [3, "title", "dataWords", 4, "ngFor", "ngForOf"], [3, "title", "dataWords"], [1, "sub-title"], [3, "title", "data"], [3, "title", "data", "show"], [3, "dateFrom", "dateTo", "title", "subTitle", "dataLines", "show"]], template: function ResumeComponent_Template(rf, ctx) { if (rf & 1) {
